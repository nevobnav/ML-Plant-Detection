...
class NetworkTrainer(object):
	...
	def set_training_data(self, data_path, batch_size=64):
		...
		def DataIterator(generator, dir_c, dir_h, dir_m, seed=0):
			rgb_flow = generator.flow_from_directory(dir_c, target_size=rgb_size, class_mode='categorical',
				batch_size=batch_size, shuffle=True, seed=seed, color_mode='rgb')
			dem_flow = generator.flow_from_directory(dir_h, target_size=dem_size, class_mode='categorical',
				batch_size=batch_size, shuffle=True, seed=seed, color_mode='grayscale')
			msk_flow = generator.flow_from_directory(dir_m, target_size=rgb_size, class_mode='categorical',
				batch_size=batch_size, shuffle=True, seed=seed, color_mode='grayscale')
			while True:
